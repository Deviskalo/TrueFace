    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-3 text-blue-600 hover:text-blue-800 transition-colors mb-6">
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">TrueFace</span>
          </Link>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center space-x-6">
              ...
              <div className={`h-1 w-16 rounded-full transition-all duration-500 ${ 
                ["camera", "processing"].includes(currentStep) ? "bg-gradient-to-r from-green-400 to-green-500" : "bg-gray-200"
              }`}></div>
              <div className="flex flex-col items-center space-y-2">
                <div className={`flex items-center justify-center w-12 h-12 rounded-2xl text-sm font-bold transition-all duration-300 ${
                  currentStep === "camera" 
              ...
              <div className={`h-1 w-16 rounded-full transition-all duration-500 ${ 
                currentStep === "processing" ? "bg-gradient-to-r from-green-400 to-green-500" : "bg-gray-200"
              }`}></div>
              <div className="flex flex-col items-center space-y-2">
                <div className={`flex items-center justify-center w-12 h-12 rounded-2xl text-sm font-bold transition-all duration-300 ${
                  currentStep === "processing" ? "bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg scale-110" : "bg-gray-200 text-gray-500"
                }`}>
          ...
          {currentStep === "intro" && (
            <div className="text-center space-y-8">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-3">Instant Access</h2>
              ...
              {error && (
                <div className="bg-red-50/80 backdrop-blur-sm border border-red-200 rounded-2xl p-6 max-w-md mx-auto">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-red-800 font-medium mb-1">Authentication Failed</p>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <Link 
                    href="/auth/signup" 
                    className="inline-flex items-center space-x-2 text-blue-600 hover:text-indigo-600 transition-colors font-semibold group"
                  >
                    <span>🆕</span>
          ...
          {currentStep === "camera" && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-3">Face Recognition</h2>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm p-4 rounded-3xl shadow-2xl border border-white/30">
                  <CameraCapture
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6">
                <div className="flex items-center justify-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Camera Active</span>
                  </div>
                  <div className="h-4 w-px bg-gray-300"></div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-blue-400 rounded-full animate-bounce"></div>
                    <span className="text-sm font-medium text-gray-700">Ready to Capture</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <button
                  onClick={resetLogin}
                  className="inline-flex items-center space-x-2 text-gray-500 hover:text-gray-700 transition-colors font-medium group bg-white/50 backdrop-blur-sm px-6 py-3 rounded-2xl border border-gray-200/50 hover:bg-white/70 hover:shadow-lg"
                >
                  <span className="transform group-hover:-translate-x-1 transition-transform">←</span>
          ...
          {currentStep === "processing" && (
            <div className="text-center space-y-8">
              <div className="relative">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-purple-100 to-blue-100 rounded-3xl mb-4">
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    <img 
                      src={capturedImage} 
                      alt="Captured face" 
                      className="w-32 h-32 rounded-3xl border-4 border-blue-200 object-cover shadow-xl"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-3xl animate-pulse"></div>
                    <div className="absolute -inset-2 border-2 border-blue-400 rounded-3xl border-dashed opacity-60 animate-spin" style={{animationDuration: '3s'}}></div>
                  </div>
                </div>
              )}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6">
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">Secure verification in progress</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="text-center mt-8">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm px-6 py-3 rounded-2xl border border-white/30 shadow-lg">
